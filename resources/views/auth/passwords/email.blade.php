...
<div class="container mx-auto flex justify-center">
    <div class="row bg-gray-200 py-4 px-6 rounded">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-semibold mb-2">{{ __('Reset Password') }}</div>
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="bmt-4 px-4 py-3 rounded uppercase text-sm bg-blue-400 text-white">
